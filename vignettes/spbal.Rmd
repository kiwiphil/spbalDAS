...
vignette: >
  %\VignetteIndexEntry{Spatially Balanced Sampling Methods}
...
The **spbal** package has five spatially balanced sample designs: BAS, Halton Frames, HIP, DAS and doubleDAS. This document illustrates how samples are drawn using **spbal**, including master and stratified sampling applications. The package is freely available from CRAN. This document was created with **spbal** version $1.0.2$.
